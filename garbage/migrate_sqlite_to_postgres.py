...
# --- SQLITE (source) ---
#SQLITE_PATH = Path(r"C:\Users\placi\PYTHON\KM_Project\contributions.db")
SQLITE_PATH = Path("C:/Users/placi/PYTHON/KM_Project/contributions.db")

# --- POSTGRES (destination) ---
PGHOST = "localhost"
PGPORT = "5432"          # PostgreSQL port (Flask reste sur 5000)
PGDATABASE = "KM_db"
PGUSER = "KM_user"
PGPASSWORD = "1959"
...
def main():
    ...
    with pconn:
        with pconn.cursor() as pcur:
            ...
            # 2b) Éviter doublons (on se base sur max(id) déjà présent)
