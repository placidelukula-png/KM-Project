...
<div class="container">
    ...
    <div class="right">
        ...
        <div class="navigation-buttons" style="margin-top: 20px; display: flex; gap: 10px;border-radius: 20px;background: rgba(25,25,112,1);justify-content: center; align-items: center;">
            <!-- Bouton Inscription -->
