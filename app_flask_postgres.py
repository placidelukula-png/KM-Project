...
<div class="container">
    ...
    <div class="right">
        ...
        <div class="navigation-buttons" style="margin-top: 20px; display: flex; gap: 10px;border-radius: 20px;color: rgba(0,0,0,1);background-color: rgba(220,220,220,1);justify-content: center; align-items: center;">
            <!-- Bouton Inscription -->
            ...
            <a href="{{ url_for('infos_association') }}">
                <button type="button" class="btn btn-primary" style="font-size: 0.7em;">A propos de notre association</button>
            </a>
        </div>
...
def import_mouvements():
    ...
    # CONTRIBUTION ATTENDUE ACTUELLE: à partir de la table id_data et du champ "C" (contribution minimale) 
...
<style>
 ...
 .mon-financial-warning { margin-top:12px;padding:20px;border-radius:12px;background-color: #fff3cd; color: #856404; border: 1px solid #ffeeba; }
